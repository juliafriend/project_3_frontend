...
const App = () => {
  ...
  const handleDelete = (travelData) => {
    axios
        .delete(`https://arcane-garden-99958.herokuapp.com/${travelData._id}`)
        .then(() => {
          axios
              .get('https://arcane-garden-99958.herokuapp.com')
              .then((response) => {
                setTravel(response.data)
              });
        });
  ...
  const handleUpdateName = (travelData)=>{
    axios.put(`https://arcane-garden-99958.herokuapp.com/${travelData._id}`,
        {
          name: updatedName,
      ...
      ).then((response) => { axios.get('https://arcane-garden-99958.herokuapp.com')
          .then((response) => {
            setTravel(response.data);
          })
    })
